...
@Module({
  imports: [KeycloackModule, ClientsModule.registerAsync([GrpcProvider(GRPC_SERVICES.USER_ACCESS_SERVICE)])],
  controllers: [AuthorizerController, AuthorizerGrpcController],
  providers: [AuthorizerService, TcpProvider(TCP_SERVICES.USER_ACCCESS_SERVICE)],
})
